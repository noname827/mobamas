...
(lib.bg = function() {
	this.initialize(img._486_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.book = function() {
	this.initialize(img._486_4_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_base = function() {
	this.initialize(img._486_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_face10 = function() {
	this.initialize(img._486_4_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face2 = function() {
	this.initialize(img._486_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face3 = function() {
	this.initialize(img._486_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face4 = function() {
	this.initialize(img._486_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face5 = function() {
	this.initialize(img._486_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face6 = function() {
	this.initialize(img._486_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face7 = function() {
	this.initialize(img._486_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face8 = function() {
	this.initialize(img._486_4_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ch_face9 = function() {
	this.initialize(img._486_4_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,220,220);


(lib.ef01 = function() {
	this.initialize(img._486_4_ef01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,165,172);


(lib.ef1 = function() {
	this.initialize(img._486_4_ef1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ef2 = function() {
	this.initialize(img._486_4_ef2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ef3 = function() {
	this.initialize(img._486_4_ef3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.finish = function() {
	this.initialize(img._486_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._486_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._486_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._486_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.ef03 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.ef03, new cjs.Rectangle(0,0,600,700), null);


(lib.ef02 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.ef02, new cjs.Rectangle(0,0,600,700), null);
...
}).prototype = getMCSymbolPrototype(lib.ef01_1, new cjs.Rectangle(0,0,600,700), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,600.1,700.1);
...
(lib.eff02_m = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0.1,scaleX:0.6995,scaleY:0.6995,rotation:45,x:-0.25,y:0.25},6).to({regX:-0.2,regY:-0.6,scaleX:0.1705,scaleY:0.1705,rotation:198.2582,x:0,y:0.1},6).wait(1));
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(55.975,0.4);
	...
	this.shape_1.setTransform(40.125,0.975);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("Ag5AuIAAgOIAyAAIAAg/IgsAAIAAgPIBmAAIAAAPIgqAAIAAA/IAwAAIAAAOg");
	this.shape_2.setTransform(23.95,2.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("Ag4AxQAagGASgJQARgJAMgNQALgMAGgOQAGgPACgSIgRABIgXAAIgXAAIgVAAIgPAAIgGAAIAAgRIAHAAIARAAIAYAAIAaAAIAZAAIATAAIAJAAQgCAigMAaQgMAZgXARQgWARgjAIg");
	this.shape_3.setTransform(8.175,0.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AhCA5QAUgIAMgMQANgMAGgPQAGgPACgUIgwAAIAAgQIAyAAIAAgOIAAgOIARAAIAAAOIAAAOIA3AAIAAAYIgBAXIgBAWIgDAOQgDALgGAGQgHAFgHACQgIABgHAAIgIAAIgFAAIgHgSIAKABIALAAIAHAAQAEgBAEgDQADgDADgGIABgNIACgRIAAgRIAAgPIgnAAQgCAXgHAQQgGASgNAOQgNAOgUAKg");
	this.shape_4.setTransform(-8.55,0.45);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(-40,0.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AAoBMIAAgJIhPAAIAAAJIgRAAIAAhLIAwAAIAAggIg/AAIAAgPIA/AAIAAgdIAQAAIAAAdIA/AAIAAAPIg/AAIAAAgIAwAAIAABLgAgnA0IBPAAIAAgkIhPAAg");
	this.shape_7.setTransform(-56,0.425);
...
(lib.ef = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(300,350,1,1,0,0,0,300,350);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.6992},19).to({alpha:0.9883},20).wait(1));

	// ef2
	this.instance_1 = new lib.ef02();
	this.instance_1.parent = this;
	this.instance_1.setTransform(300,350,1,1,0,0,0,300,350);
	this.instance_1.alpha = 0.3008;
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:0.8008},19).to({alpha:0.3086},20).wait(1));

	// ef3
	this.instance_2 = new lib.ef03();
	this.instance_2.parent = this;
	this.instance_2.setTransform(300,350,1,1,0,0,0,300,350);
	this.instance_2.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:0.6016},19).to({alpha:0.9883},20).wait(1));

	// ef4
	this.instance_3 = new lib.ef03();
	this.instance_3.parent = this;
	this.instance_3.setTransform(316.25,350,1,1,0,0,0,300,350);
	this.instance_3.alpha = 0.3984;
	this.instance_3.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:0.8008},19).to({alpha:0.4102},20).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,616.3,700);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 1, 0, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AFCDqIi5g7IjGhPQgwAHg5AEQhzAKgxgJQg5gKgtgiQgsgigRgtQgPgnBFhIQA3g7AzgdQBRgsBTAkQA+AaA6BDQAoAwApAFQAvAGBTgqQBKglBIALQBJALA8A7QA0AzAEBeQADBRgaAvQgSAghFACg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:56.0865,y:41.0574}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-300.5,-190,600,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-140,-314);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-260,-710,600,841.7);
...
(lib.water_move = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.book();
	this.instance.parent = this;
	this.instance.setTransform(0,6,0.4996,0.4996);

	this.instance_1 = new lib.concent_wrapper("synched",7,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(353.5,237.8,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.water_move, new cjs.Rectangle(0,6,599.5,699.4), null);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(151.85,-564.35,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(160.3,-513.75,0.4532,0.4532,0,0,180);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.45,y:-573.35,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:189.1,y:-577.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:151.85,y:-564.35,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.45,y:-573.35,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:189.1,y:-577.65,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:151.85,y:-564.35,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.45,y:-573.35,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:189.1,y:-577.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:151.85,y:-564.35,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.45,y:-573.35,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:189.1,y:-577.65,alpha:0.2188},0).to({_off:true},1).wait(155));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:162.05,y:-527.9,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:165.3,y:-533.75,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:162.75,y:-531.6,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:162.2,y:-528.35,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:163.3,y:-523.75,alpha:0},0).to({_off:true},1).wait(111));

	// k3
	this.instance_2 = new lib.eff02_m();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-27.55,-153.5,0.0649,0.0649,0,0,0,1.6,1.6);
	this.instance_2.compositeOperation = "lighter";

	this.instance_3 = new lib.eff02_m();
	this.instance_3.parent = this;
	this.instance_3.setTransform(42.7,-214.45,0.0728,0.0728,0,0,0,0.7,0.7);
	this.instance_3.compositeOperation = "lighter";

	this.instance_4 = new lib.eff02_m();
	this.instance_4.parent = this;
	this.instance_4.setTransform(167.15,-146.8,0.0846,0.0846,0,0,0,24.2,-14.8);
	this.instance_4.compositeOperation = "lighter";

	this.instance_5 = new lib.eff02_m();
	this.instance_5.parent = this;
	this.instance_5.setTransform(242.95,-209.8,0.1091,0.1091,0,0,0,1.9,1.4);
	this.instance_5.compositeOperation = "lighter";

	this.instance_6 = new lib.eff02_m();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-78.2,-227.3,0.0649,0.0649,0,0,0,1.6,1.6);
	this.instance_6.compositeOperation = "lighter";

	this.instance_7 = new lib.eff02_m();
	this.instance_7.parent = this;
	this.instance_7.setTransform(126.1,-185.2,0.0846,0.0846,0,0,0,24.2,-14.8);
	this.instance_7.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]},474).to({state:[]},12).wait(1));

	// k2
	this.instance_8 = new lib.eff02_m();
	this.instance_8.parent = this;
	this.instance_8.setTransform(88.75,-216.35,0.102,0.102,0,0,0,-111.8,-82.4);
	this.instance_8.compositeOperation = "lighter";

	this.instance_9 = new lib.eff02_m();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-28.45,-170.25,0.085,0.085,0,0,0,-1320.6,-32.4);
	this.instance_9.compositeOperation = "lighter";

	this.instance_10 = new lib.eff02_m();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-49.55,-154.1,0.1241,0.1241,0,0,0,0.8,0.8);
	this.instance_10.compositeOperation = "lighter";

	this.instance_11 = new lib.eff02_m();
	this.instance_11.parent = this;
	this.instance_11.setTransform(20.1,-144.1,0.068,0.068,0,0,0,0.8,0);
	this.instance_11.compositeOperation = "lighter";

	this.instance_12 = new lib.eff02_m();
	this.instance_12.parent = this;
	this.instance_12.setTransform(237.3,-213.35,0.0934,0.0934,0,0,0,2.1,1.1);
	this.instance_12.compositeOperation = "lighter";

	this.instance_13 = new lib.eff02_m();
	this.instance_13.parent = this;
	this.instance_13.setTransform(-67.6,-213.35,0.0901,0.0901,0,0,0,0.6,0.6);
	this.instance_13.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]},465).to({state:[]},12).wait(10));

	// k1
	this.instance_14 = new lib.eff02_m();
	this.instance_14.parent = this;
	this.instance_14.setTransform(131.65,-148.1,0.1343,0.1343,0,0,0,1.5,1.5);
	this.instance_14.compositeOperation = "lighter";

	this.instance_15 = new lib.eff02_m();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-32.75,-154.55,0.1067,0.1067,0,0,0,0,-0.5);
	this.instance_15.compositeOperation = "lighter";

	this.instance_16 = new lib.eff02_m();
	this.instance_16.parent = this;
	this.instance_16.setTransform(-10.7,-172.3,0.0496,0.0496,0,0,0,1,-1);
	this.instance_16.compositeOperation = "lighter";

	this.instance_17 = new lib.eff02_m();
	this.instance_17.parent = this;
	this.instance_17.setTransform(-63.1,-235.4,0.1036,0.1036,0,0,0,1,0.5);
	this.instance_17.compositeOperation = "lighter";

	this.instance_18 = new lib.eff02_m();
	this.instance_18.parent = this;
	this.instance_18.setTransform(148.55,-197.3,0.1305,0.1305,0,0,0,2.3,0.8);
	this.instance_18.compositeOperation = "lighter";

	this.instance_19 = new lib.eff02_m();
	this.instance_19.parent = this;
	this.instance_19.setTransform(-1.2,-168.45,0.0496,0.0496,0,0,0,-1,-2);
	this.instance_19.compositeOperation = "lighter";

	this.instance_20 = new lib.eff02_m();
	this.instance_20.parent = this;
	this.instance_20.setTransform(-33.25,-209.05,0.0528,0.0528,0,0,0,1,0);
	this.instance_20.compositeOperation = "lighter";

	this.instance_21 = new lib.eff02_m();
	this.instance_21.parent = this;
	this.instance_21.setTransform(198.75,-157.1,0.1305,0.1305,0,0,0,2.7,0.8);
	this.instance_21.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14}]},453).to({state:[]},12).wait(22));

	// effect_look_to_right
	this.instance_22 = new lib.spread_flower_pink("synched",0,false);
	this.instance_22.parent = this;
	this.instance_22.setTransform(100.7,-471.6,1.4807,1.4807,0,0,180);

	this.instance_23 = new lib.good_effect("synched",0,false);
	this.instance_23.parent = this;
	this.instance_23.setTransform(100.75,-471.65,1.481,1.481);

	this.instance_24 = new lib.notice();
	this.instance_24.parent = this;
	this.instance_24.setTransform(174.4,-559.9,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_24._off = true;

	this.instance_25 = new lib.laugh("synched",0);
	this.instance_25.parent = this;
	this.instance_25.setTransform(190.4,-556.35,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_25._off = true;

	this.instance_26 = new lib.chord("synched",0,false);
	this.instance_26.parent = this;
	this.instance_26.setTransform(167.3,-473.95,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_27 = new lib.question();
	this.instance_27.parent = this;
	this.instance_27.setTransform(162.6,-556.85,1.053,1.053,29.448);
	this.instance_27.alpha = 0;
	this.instance_27._off = true;

	this.instance_28 = new lib.mc_exclamation("synched",0,false);
	this.instance_28.parent = this;
	this.instance_28.setTransform(159.35,-572.25,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_29 = new lib.drop1a("synched",0);
	this.instance_29.parent = this;
	this.instance_29.setTransform(155.05,-554.75,1,1,0,0,0,-0.5,0.2);
	this.instance_29._off = true;

	this.instance_30 = new lib.drop2_v2("synched",0);
	this.instance_30.parent = this;
	this.instance_30.setTransform(153.65,-554.6,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_30._off = true;

	this.instance_31 = new lib.shock("synched",0);
	this.instance_31.parent = this;
	this.instance_31.setTransform(160.1,-557.6,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_32 = new lib.sigh("synched",0);
	this.instance_32.parent = this;
	this.instance_32.setTransform(133.65,-404.3,1,1,0,0,180);
	this.instance_32.alpha = 0.6016;
	this.instance_32._off = true;

	this.instance_33 = new lib.heart("synched",0);
	this.instance_33.parent = this;
	this.instance_33.setTransform(160.3,-513.75,0.4532,0.4532,0,0,180);
	this.instance_33._off = true;

	this.instance_34 = new lib.angry("synched",0);
	this.instance_34.parent = this;
	this.instance_34.setTransform(166.85,-535,0.5276,0.5276);
	this.instance_34._off = true;

	this.instance_35 = new lib.mc_punpun();
	this.instance_35.parent = this;
	this.instance_35.setTransform(35.8,-584.15,1.1377,1.1377);

	this.instance_36 = new lib.concent_wrapper("synched",0,false);
	this.instance_36.parent = this;
	this.instance_36.setTransform(93.5,-472.2,1,1,0,0,0,-0.5,-0.1);

	this.instance_37 = new lib.water_move("single",0);
	this.instance_37.parent = this;
	this.instance_37.setTransform(-134.8,-211.65,0.3338,0.3471,0,-28.7618,-0.4453,121.3,494.6);
	this.instance_37._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_22}]},37).to({state:[{t:this.instance_23}]},10).to({state:[]},10).to({state:[{t:this.instance_24}]},76).to({state:[]},2).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},2).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[]},1).to({state:[{t:this.instance_24}]},2).to({state:[]},2).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},2).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).to({state:[]},1).to({state:[{t:this.instance_25}]},1).to({state:[{t:this.instance_25}]},15).to({state:[{t:this.instance_25}]},1).to({state:[{t:this.instance_25}]},1).to({state:[{t:this.instance_25}]},1).to({state:[{t:this.instance_25}]},1).to({state:[]},1).to({state:[{t:this.instance_26}]},1).to({state:[]},20).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},2).to({state:[{t:this.instance_27}]},7).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[]},1).to({state:[{t:this.instance_27}]},6).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},2).to({state:[{t:this.instance_27}]},2).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_27}]},1).to({state:[]},1).to({state:[{t:this.instance_28}]},5).to({state:[{t:this.instance_29}]},16).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},9).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_29}]},1).to({state:[]},1).to({state:[{t:this.instance_30}]},24).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[]},1).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[]},1).to({state:[{t:this.instance_30}]},5).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[]},1).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_30}]},1).to({state:[]},1).to({state:[{t:this.instance_31}]},11).to({state:[]},1).to({state:[{t:this.instance_31}]},1).to({state:[]},1).to({state:[{t:this.instance_31}]},1).to({state:[]},1).to({state:[{t:this.instance_32}]},3).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_32}]},1).to({state:[]},1).to({state:[{t:this.instance_33}]},11).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},2).to({state:[{t:this.instance_33}]},3).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_33}]},1).to({state:[]},1).to({state:[{t:this.instance_34}]},6).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},5).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_34}]},1).to({state:[]},1).to({state:[{t:this.instance_35}]},2).to({state:[]},12).to({state:[{t:this.instance_36}]},17).to({state:[]},9).to({state:[{t:this.instance_37}]},8).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_37}]},1).to({state:[]},1).wait(28));
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-559.95},0).wait(3).to({regX:-28.8,x:174,y:-559.8,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:174.4,y:-559.95,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-559.9,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-559.95},0).wait(3).to({regX:-28.8,x:174,y:-559.8,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:174.4,y:-559.95,alpha:0},0).to({_off:true},1).wait(328));
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(160).to({_off:false},0).wait(15).to({regY:20.4,skewX:-35.827,skewY:144.1725,x:190.3,y:-556.4},0).wait(1).to({regX:-31.4,regY:22.1,x:193.1,y:-555.45,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.4,x:190.3,y:-556.4,alpha:0,startPosition:19},0).to({_off:true},1).wait(307));
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:170.25,y:-569.8,alpha:0.5556},0).wait(1).to({x:175.05,y:-577.65,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:177,y:-580.45,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:176.35,y:-579.7},0).wait(1).to({x:175.3,y:-577.85},0).wait(1).to({x:173.55,y:-574.75},0).wait(1).to({regX:0,regY:0,x:171.4,y:-570.55},0).to({x:172.15,y:-571.9},2).wait(8).to({regX:-0.2,regY:0.2,x:171.5,y:-571.2,alpha:0.9298},0).wait(1).to({x:170.4,y:-569.25,alpha:0.692},0).wait(1).to({x:168.8,y:-566.4,alpha:0.339},0).wait(1).to({x:167.6,y:-564.3,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-563.75,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:162.6,y:-556.85},0).wait(1).to({regX:-0.2,regY:0.2,x:170.25,y:-569.8,alpha:0.5556},0).wait(1).to({x:175.05,y:-577.65,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:177,y:-580.45,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:176.35,y:-579.7},0).wait(1).to({x:175.3,y:-577.85},0).wait(1).to({x:173.55,y:-574.75},0).wait(1).to({regX:0,regY:0,x:171.4,y:-570.55},0).to({x:172.15,y:-571.9},2).wait(3).to({regX:-0.2,regY:0.2,x:171.5,y:-571.2,alpha:0.9298},0).wait(1).to({x:170.4,y:-569.25,alpha:0.692},0).wait(1).to({x:168.8,y:-566.4,alpha:0.339},0).wait(1).to({x:167.6,y:-564.3,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-563.75,alpha:0},0).to({_off:true},1).wait(240));
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:156.05,y:-551.05},0).wait(1).to({y:-547.2},0).wait(1).to({y:-543.95},0).wait(1).to({y:-541.3},0).wait(1).to({y:-539.2},0).wait(1).to({y:-537.7},0).wait(1).to({y:-536.8},0).wait(1).to({regX:-0.5,regY:0.2,x:155.05,y:-535.75},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:156.05,y:-536.55,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:155.05,y:-535.75,alpha:0},0).to({_off:true},1).wait(198));
	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:185.075,y:-549.9875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.55,y:-548.45,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.65,y:-554.6,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:185.075,y:-554.375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.55,y:-554.3,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.65,y:-554.6,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:185.075,y:-549.9875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.55,y:-548.45,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.65,y:-554.6,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:185.075,y:-554.375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.55,y:-554.3,alpha:0.2188},0).to({_off:true},1).wait(155));
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(351).to({_off:false},0).wait(1).to({x:134.65,y:-403.3,alpha:1},0).wait(1).to({regX:0.9,x:134.75,y:-402.35,alpha:0.8965},0).wait(1).to({x:136.1,y:-401.15,alpha:0.7636},0).wait(1).to({x:137.7,y:-399.7,alpha:0.6048},0).wait(1).to({x:139.5,y:-398.1,alpha:0.4229},0).wait(1).to({x:141.5,y:-396.25,alpha:0.2205},0).wait(1).to({regX:0,x:144.65,y:-394.3,alpha:0},0).to({_off:true},1).wait(128));
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:162.05,y:-527.9},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:165.3,y:-533.75},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:162.75,y:-531.6},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:162.2,y:-528.35},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:163.3,y:-523.75},0).to({scaleX:1,scaleY:1,x:164.3,y:-527.75},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:161.7,y:-526.75,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:163.3,y:-527.5,alpha:0.1016},0).to({_off:true},1).wait(104));
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-538.75},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-540},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(85));
	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(450).to({_off:false},0).wait(1).to({regX:355.3,regY:270.5,scaleX:0.6133,scaleY:0.621,skewX:-17.8876,skewY:-1.4705,x:-28.35,y:-350.05},0).wait(1).to({scaleX:0.8172,scaleY:0.8207,skewX:-9.9524,skewY:-2.2186,x:34.45,y:-404.2},0).wait(1).to({regX:121.2,regY:494.4,scaleX:0.9456,scaleY:0.9465,skewX:-4.9561,skewY:-2.6896,x:-122.2,y:-216.7},0).wait(1).to({regX:355.3,regY:270.5,scaleX:1.0588,scaleY:1.0661,skewX:-2.1509,skewY:-0.7282,x:121.45,y:-454.7,alpha:0.6792},0).wait(1).to({regX:121.2,regY:494.4,scaleX:1.1469,scaleY:1.159,skewX:0.0309,skewY:0.7974,x:-113.7,y:-210.2,alpha:0.4297},0).to({regX:121.1,scaleX:1.2097,scaleY:1.2253,skewX:1.5442,skewY:2.0038,x:-111.25,y:-203.85,alpha:0.25},1).to({scaleX:1.2474,scaleY:1.2651,rotation:2.5309,skewX:0,skewY:0,x:-109.55,y:-203.3,alpha:0.1406},1).to({regX:121.9,regY:494.8,scaleX:1.2602,scaleY:1.2786,rotation:2.9853,x:-108.95,y:-203.95,alpha:0.1016},1).to({_off:true},1).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:40,regY:-360,x:40,y:-364.25},0).wait(1).to({regX:0,regY:0,x:0,y:-5.1},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.6},0).wait(1).to({y:-363.05},0).wait(1).to({regX:0,regY:0,x:0,y:2.3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:40,regY:-360,x:40,y:-365.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:40,regY:-360,x:40,y:-365.75},0).wait(1).to({y:-358.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:40,regY:-360,x:40,y:-356.75},0).wait(1).to({y:-359.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.95},0).wait(1).to({y:-359.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.95},0).wait(1).to({y:-359.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:40,regY:-360,x:40,y:-359.1},0).wait(1).to({y:-359.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:40,regY:-360,x:40,y:-369},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:40,regY:-360,x:40,y:-372.95},0).wait(1).to({y:-369.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:40,regY:-360,x:40,y:-358},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:40,regY:-360,x:40,y:-360.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:40,regY:-360,x:40,y:-369},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:40,regY:-360,x:40,y:-372.95},0).wait(1).to({y:-369.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:40,regY:-360,x:40,y:-358},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:40,regY:-360,x:40,y:-360.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,x:40,y:-359.4},0).wait(1).to({y:-357},0).wait(1).to({y:-354.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:40,regY:-360,x:40,y:-354.65},0).wait(1).to({y:-357},0).wait(1).to({y:-359.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,x:40,y:-359.85},0).wait(1).to({y:-359.3},0).wait(1).to({y:-358.2},0).wait(1).to({y:-356.85},0).wait(1).to({y:-355.75},0).wait(1).to({y:-355.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:40,regY:-360,x:40,y:-355.2},0).wait(1).to({y:-355.75},0).wait(1).to({y:-356.85},0).wait(1).to({y:-358.2},0).wait(1).to({y:-359.3},0).wait(1).to({y:-359.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:40,regY:-360,x:40,y:-355.25},0).wait(1).to({y:-358.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:40,regY:-360,x:40,y:-357.8},0).wait(1).to({y:-359.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,rotation:0.0162,x:40.1,y:-360},0).wait(1).to({rotation:0.0725,x:40.6,y:-359.75},0).wait(1).to({rotation:0.1826,x:41.5,y:-359.3},0).wait(1).to({rotation:0.3572,x:43,y:-358.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.5763,x:44.8,y:-357.8},0).wait(1).to({rotation:0.775,x:46.45,y:-357},0).wait(1).to({rotation:0.9076,x:47.6,y:-356.5},0).wait(1).to({rotation:0.9756,x:48.15,y:-356.25},0).wait(1).to({regX:0.1,regY:0.1,rotation:0.9951,x:2.05,y:3.1},0).wait(1).to({regX:40,regY:-360,rotation:0.9821,x:48.05,y:-356.25},0).wait(1).to({rotation:0.9377,x:47.7,y:-356.45},0).wait(1).to({rotation:0.8521,x:46.95,y:-356.75},0).wait(1).to({rotation:0.7154,x:45.85,y:-357.35},0).wait(1).to({rotation:0.5305,x:44.3,y:-358.05},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.333,x:42.65,y:-358.75},0).wait(1).to({rotation:0.1728,x:41.3,y:-359.45},0).wait(1).to({rotation:0.0693,x:40.45,y:-359.8},0).wait(1).to({rotation:0.0156,x:40,y:-360},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,rotation:0.0244,x:40.15,y:-359.95},0).wait(1).to({rotation:0.1092,x:40.8,y:-359.55},0).wait(1).to({rotation:0.275,x:42.05,y:-358.9},0).wait(1).to({rotation:0.538,x:44.1,y:-357.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:46.6,y:-356.5},0).wait(1).to({rotation:1.1673,x:48.9,y:-355.25},0).wait(1).to({rotation:1.367,x:50.4,y:-354.35},0).wait(1).to({rotation:1.4695,x:51.2,y:-353.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:40,regY:-360,rotation:1.4793,x:51.2,y:-353.95},0).wait(1).to({rotation:1.4124,x:50.65,y:-354.2},0).wait(1).to({rotation:1.2834,x:49.7,y:-354.75},0).wait(1).to({rotation:1.0775,x:48.1,y:-355.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:46,y:-356.8},0).wait(1).to({rotation:0.5016,x:43.75,y:-358},0).wait(1).to({rotation:0.2603,x:41.9,y:-359},0).wait(1).to({rotation:0.1043,x:40.7,y:-359.7},0).wait(1).to({rotation:0.0235,x:40.15,y:-360},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:40,regY:-360,x:40,y:-365.55},0).wait(1).to({y:-367.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:40,regY:-360,x:40,y:-367.35},0).wait(1).to({y:-365.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:40,regY:-360,x:40,y:-368.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:40,regY:-360,x:40,y:-369.2},0).wait(1).to({y:-366.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(35).to({regX:40,regY:-360,rotation:0.1421,x:41.05,y:-359.45},0).wait(1).to({rotation:0.6998,x:45.3,y:-357.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:50.1,y:-354.5},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:40,regY:-360,rotation:1.4399,x:50.9,y:-354.1},0).wait(1).to({rotation:1.2196,x:49.2,y:-355.05},0).wait(1).to({rotation:0.7884,x:45.95,y:-356.8},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:42.3,y:-358.7},0).wait(1).to({rotation:0.0482,x:40.3,y:-359.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:40,regY:-360,rotation:0.0865,x:40.65,y:-359.7},0).wait(1).to({rotation:0.4213,x:43.2,y:-358.3},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:47.55,y:-355.9},0).wait(1).to({rotation:1.3945,x:50.6,y:-354.25},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:40,regY:-360,rotation:1.4399,x:50.9,y:-354.1},0).wait(1).to({rotation:1.2196,x:49.2,y:-355.05},0).wait(1).to({rotation:0.7884,x:45.95,y:-356.8},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:42.3,y:-358.7},0).wait(1).to({rotation:0.0482,x:40.3,y:-359.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:40,regY:-360,x:40,y:-368.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:40,regY:-360,x:40,y:-369.2},0).wait(1).to({y:-366.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:40,regY:-360,x:37.25,y:-352.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:40,regY:-360,x:40,y:-347.75},0).wait(1).to({y:-350.7},0).wait(1).to({y:-355.65},0).wait(1).to({y:-359.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:40,regY:-360,x:40,y:-359},0).wait(1).to({y:-353.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:40,regY:-360,x:40,y:-352.2},0).wait(1).to({y:-356.5},0).wait(1).to({y:-360.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:40,regY:-360,x:40,y:-360.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,x:40,y:-366.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:40,regY:-360,x:40,y:-366.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:40,regY:-360,x:40,y:-368.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:40,regY:-360,x:40,y:-369.2},0).wait(1).to({y:-366.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:40,regY:-360,x:37.25,y:-352.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:40,regY:-360,x:40,y:-349.25},0).wait(1).to({y:-357},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:40,regY:-360,x:40,y:-361},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:40,regY:-360,x:40,y:-360.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:40,regY:-360,x:40,y:-359.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,x:40,y:-359.4},0).wait(1).to({y:-357},0).wait(1).to({y:-354.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:40,regY:-360,x:40,y:-354.6},0).wait(1).to({y:-354.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:40,regY:-360,x:40,y:-355.4},0).wait(1).to({y:-356.9},0).wait(1).to({y:-359.15},0).wait(1).to({y:-360.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:40,regY:-360,x:40,y:-360.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:40,regY:-360,x:40,y:-367.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:40,regY:-360,x:40,y:-369.2},0).wait(1).to({y:-366.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:40,regY:-360,x:40,y:-367.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:40,regY:-360,x:40,y:-368},0).wait(1).to({y:-362},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:40,regY:-360,x:40,y:-355.35},0).wait(1).to({y:-356.55},0).wait(1).to({y:-358.5},0).wait(1).to({y:-359.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.95},0).wait(1).to({y:-359.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.95},0).wait(1).to({y:-359.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:40,regY:-360,x:40,y:-359.1},0).wait(1).to({y:-359.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:40,regY:-360,x:43,y:-356.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:40,regY:-360,x:39.15,y:-350.55},0).wait(1).to({x:39.8,y:-350.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:40,regY:-360,x:40,y:-350.7},0).wait(1).to({y:-353.15},0).wait(1).to({y:-356.85},0).wait(1).to({y:-359.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:40,regY:-360,x:40,y:-359.4},0).wait(1).to({y:-357},0).wait(1).to({y:-354.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:40,regY:-360,x:40,y:-354.65},0).wait(1).to({y:-357},0).wait(1).to({y:-359.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:40,regY:-360,x:40,y:-363.8},0).wait(1).to({y:-365.1},0).wait(1).to({regX:0,regY:0,x:0,y:-5.5},0).wait(1).to({regX:40,regY:-360,x:40,y:-364.95},0).wait(1).to({y:-363.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(29));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-872.5,981.6,1005);
...
// stage content:
(lib._486_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:167,scene2:168,end2:343,scene3:344,end3:491,scene4:492,end4:630,scene5:631,end5:748,scene6:749,end6:897,scene7:898,end7:1064});
	...
	this.frame_63 = function() {
		exportRoot._g.m2 = "ﾌﾟﾛﾃﾞｭｰｻｰさんっ｡";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 2);
	}
	this.frame_87 = function() {
		exportRoot._g.m2 = "ﾌﾟﾛﾃﾞｭｰｻｰさんっ｡ﾊﾟｼｬ､";
		exportRoot._u.setText();
	...
	this.frame_182 = function() {
		this.ch1.gotoAndPlay("water");
	}
	this.frame_190 = function() {
		exportRoot._g.m1 = "もう一回……えいっ♪";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 1);
	}
	...
	this.frame_256 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "綺麗ですねっ｡";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 7);
	}
	this.frame_292 = function() {
		exportRoot._g.m3 = "綺麗ですねっ｡空気も､";
		exportRoot._u.setText();
	...
	this.frame_914 = function() {
		exportRoot._g.m1 = "そして､水を撒き終わったら､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_941 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "店の中で､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 6);
	}
	this.frame_954 = function() {
		exportRoot._g.m2 = "店の中で､一涼み｡";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(37).call(this.frame_52).wait(11).call(this.frame_63).wait(24).call(this.frame_87).wait(4).call(this.frame_91).wait(32).call(this.frame_123).wait(16).call(this.frame_139).wait(1).call(this.frame_140).wait(27).call(this.frame_167).wait(1).call(this.frame_168).wait(14).call(this.frame_182).wait(8).call(this.frame_190).wait(20).call(this.frame_210).wait(18).call(this.frame_228).wait(28).call(this.frame_256).wait(36).call(this.frame_292).wait(18).call(this.frame_310).wait(33).call(this.frame_343).wait(1).call(this.frame_344).wait(18).call(this.frame_362).wait(27).call(this.frame_389).wait(46).call(this.frame_435).wait(26).call(this.frame_461).wait(2).call(this.frame_463).wait(28).call(this.frame_491).wait(1).call(this.frame_492).wait(17).call(this.frame_509).wait(41).call(this.frame_550).wait(34).call(this.frame_584).wait(22).call(this.frame_606).wait(24).call(this.frame_630).wait(1).call(this.frame_631).wait(47).call(this.frame_678).wait(2).call(this.frame_680).wait(36).call(this.frame_716).wait(32).call(this.frame_748).wait(1).call(this.frame_749).wait(17).call(this.frame_766).wait(19).call(this.frame_785).wait(12).call(this.frame_797).wait(24).call(this.frame_821).wait(34).call(this.frame_855).wait(2).call(this.frame_857).wait(18).call(this.frame_875).wait(22).call(this.frame_897).wait(1).call(this.frame_898).wait(16).call(this.frame_914).wait(27).call(this.frame_941).wait(13).call(this.frame_954).wait(28).call(this.frame_982).wait(45).call(this.frame_1027).wait(18).call(this.frame_1045).wait(19).call(this.frame_1064).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1063));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(987).to({regX:132.8,regY:98.8,x:134.8,y:315.75},0).wait(1).to({y:326.4},0).wait(1).to({y:347},0).wait(1).to({y:373.55},0).wait(1).to({y:394.15},0).wait(1).to({y:404.8},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1023).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1023).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1023).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1023).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1023).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1015).to({_off:false},0).to({alpha:0.8984},7).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(898).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.1},0).wait(1).to({y:-6.35},0).wait(1).to({y:-11.65},0).wait(1).to({y:-18.8},0).wait(1).to({y:-27.55},0).wait(1).to({y:-37.5},0).wait(1).to({y:-48.35},0).wait(1).to({y:-59.45},0).wait(1).to({y:-70.35},0).wait(1).to({y:-80.45},0).wait(1).to({y:-89.15},0).wait(1).to({y:-95.9},0).wait(1).to({y:-100.25},0).wait(1).to({regX:0,x:120,y:-101.8},0).wait(58).to({y:-199.65},33,cjs.Ease.quadInOut).to({_off:true},1).wait(948));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.35},0).wait(1).to({y:309.45},0).wait(1).to({y:311.25},0).wait(1).to({y:313.65},0).wait(1).to({y:316.55},0).wait(1).to({y:319.9},0).wait(1).to({y:323.55},0).wait(1).to({y:327.3},0).wait(1).to({y:330.95},0).wait(1).to({y:334.35},0).wait(1).to({y:337.3},0).wait(1).to({y:339.55},0).wait(1).to({y:341},0).wait(1).to({regX:0,x:120,y:341.55},0).wait(58).to({y:508},33,cjs.Ease.quadInOut).to({_off:true},1).wait(948));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(631).to({_off:false},0).to({alpha:1},35).to({_off:true},232).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(631).to({_off:false},0).to({alpha:0.4492},35).to({_off:true},232).wait(171));

	// effect
	this.instance_15 = new lib.glitter_container();
	this.instance_15.parent = this;
	this.instance_15.setTransform(148.4,-0.85,1.0599,1.0599,-4.2877,0,0,-0.1,2.5);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).to({_off:true},1008).wait(46));

	// water
	this.bg1 = new lib.water();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-402.05,239.95,0.5684,0.5684,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.2,regY:-0.3,scaleX:0.6788,scaleY:0.6788,x:-83.5,y:-231.35},0).to({regX:-0.1,regY:-0.2,scaleX:0.6211,scaleY:0.6211,x:-66.15,y:-211.1},28,cjs.Ease.quadInOut).wait(9).to({y:-18.9},22,cjs.Ease.quadInOut).to({alpha:0},3).to({_off:true},1).wait(991));

	// ef
	this.bg1_1 = new lib.ef();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-22.15,-83.75,0.5684,0.5684,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({regX:-0.2,regY:-0.3,scaleX:0.6788,scaleY:0.6788,x:-83.5,y:-231.35},0).to({regX:-0.1,regY:-0.2,scaleX:0.6211,scaleY:0.6211,x:-66.15,y:-211.1},28,cjs.Ease.quadInOut).wait(9).to({y:-18.9},22,cjs.Ease.quadInOut).wait(13).to({regY:-0.3,scaleX:0.4935,scaleY:0.4935,x:-16.95,y:-32.15},33,cjs.Ease.quadInOut).wait(224).to({regY:-0.2,scaleX:0.5674,scaleY:0.5674,x:-50.1,y:-29},45,cjs.Ease.quadInOut).wait(103).to({alpha:0},12).to({_off:true},1).wait(564));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.5,regY:0.6,scaleX:0.6788,scaleY:0.6788,x:92.9,y:250.95},0).to({scaleX:0.6211,scaleY:0.6211,x:95.2,y:230.1},28,cjs.Ease.quadInOut).wait(9).to({y:422.3},22,cjs.Ease.quadInOut).wait(13).to({regX:0.4,scaleX:0.4935,scaleY:0.4935,x:111.25,y:318.45},33,cjs.Ease.quadInOut).wait(224).to({regX:0.5,scaleX:0.5674,scaleY:0.5674,x:97.4,y:374.15},45,cjs.Ease.quadInOut).wait(103).to({alpha:0},12).to({_off:true},1).wait(564));

	// bg
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-22.15,-83.75,0.5684,0.5684,0,0,0,0,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(15).to({regX:-0.2,regY:-0.3,scaleX:0.6788,scaleY:0.6788,x:-83.5,y:-231.35},0).to({regX:-0.1,regY:-0.2,scaleX:0.6211,scaleY:0.6211,x:-66.15,y:-211.1},28,cjs.Ease.quadInOut).wait(9).to({y:-18.9},22,cjs.Ease.quadInOut).wait(13).to({regY:-0.3,scaleX:0.4935,scaleY:0.4935,x:-16.95,y:-32.15},33,cjs.Ease.quadInOut).wait(224).to({regY:-0.2,scaleX:0.5674,scaleY:0.5674,x:-50.1,y:-29},45,cjs.Ease.quadInOut).wait(103).to({alpha:0},12).to({_off:true},1).wait(564));

	// bg3
	this.bg1_3 = new lib.bg_zoom_half();
	this.bg1_3.name = "bg1_3";
	this.bg1_3.parent = this;
	this.bg1_3.setTransform(-220.7,-143.95,0.9662,0.9662,0,0,0,-0.2,-0.2);
	this.bg1_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_3).wait(492).to({_off:false},0).to({x:-82.45},84,cjs.Ease.quadInOut).wait(8).to({alpha:0},11).to({_off:true},1).wait(473));

	// ef2
	this.bg1_4 = new lib.ef();
	this.bg1_4.name = "bg1_4";
	this.bg1_4.parent = this;
	this.bg1_4.setTransform(651.2,-106.65,1.0375,1.0375,0,0,0,-0.2,-0.4);

	this.timeline.addTween(cjs.Tween.get(this.bg1_4).to({_off:true},1).wait(583).to({_off:false,x:-243.25,y:-130.55},0).to({y:-111.95},22,cjs.Ease.quadInOut).wait(143).to({regX:-0.1,scaleX:1.1481,scaleY:1.1481,x:-281.6,y:-134.35},17,cjs.Ease.quadInOut).wait(132).to({regX:-0.2,regY:-0.2,scaleX:0.4935,scaleY:0.4935,x:-46.9,y:-14.25},0).to({_off:true},125).wait(46));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(920.9,630.65,1.0375,1.0375,0,0,0,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.ch2).to({_off:true},1).wait(583).to({_off:false,x:26.45,y:606.75},0).to({y:625.35},22,cjs.Ease.quadInOut).wait(143).to({regX:0.5,regY:0.8,scaleX:1.1481,scaleY:1.1481,x:16.5,y:681.25},17,cjs.Ease.quadInOut).wait(132).to({regX:0.1,regY:0.2,scaleX:0.4935,scaleY:0.4935,x:81.35,y:336.15},0).to({_off:true},125).wait(46));

	// bg 2
	this.bg1_5 = new lib.bg_zoom_half();
	this.bg1_5.name = "bg1_5";
	this.bg1_5.parent = this;
	this.bg1_5.setTransform(651.2,-106.65,1.0375,1.0375,0,0,0,-0.2,-0.4);

	this.timeline.addTween(cjs.Tween.get(this.bg1_5).to({_off:true},1).wait(583).to({_off:false,x:-243.25,y:-130.55},0).to({y:-111.95},22,cjs.Ease.quadInOut).wait(143).to({regX:-0.1,scaleX:1.1481,scaleY:1.1481,x:-281.6,y:-134.35},17,cjs.Ease.quadInOut).wait(132).to({regX:-0.2,regY:-0.2,scaleX:0.4935,scaleY:0.4935,x:-46.9,y:-14.25},0).to({_off:true},125).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1015).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1023).wait(41).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,1572.8,1389.8);
// library properties:
lib.properties = {
	id: '_486_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1656042482049", id:"_486_4_bg"},
		{src:"images/book.png?1656042482049", id:"_486_4_book"},
		{src:"images/ch_base.png?1656042482049", id:"_486_4_ch_base"},
		{src:"images/ch_face10.png?1656042482049", id:"_486_4_ch_face10"},
		{src:"images/ch_face2.png?1656042482049", id:"_486_4_ch_face2"},
		{src:"images/ch_face3.png?1656042482049", id:"_486_4_ch_face3"},
		{src:"images/ch_face4.png?1656042482049", id:"_486_4_ch_face4"},
		{src:"images/ch_face5.png?1656042482049", id:"_486_4_ch_face5"},
		{src:"images/ch_face6.png?1656042482049", id:"_486_4_ch_face6"},
		{src:"images/ch_face7.png?1656042482049", id:"_486_4_ch_face7"},
		{src:"images/ch_face8.png?1656042482049", id:"_486_4_ch_face8"},
		{src:"images/ch_face9.png?1656042482049", id:"_486_4_ch_face9"},
		{src:"images/ef01.png?1656042482049", id:"_486_4_ef01"},
		{src:"images/ef1.png?1656042482049", id:"_486_4_ef1"},
		{src:"images/ef2.png?1656042482049", id:"_486_4_ef2"},
		{src:"images/ef3.png?1656042482049", id:"_486_4_ef3"},
		{src:"images/finish.jpg?1656042482049", id:"_486_4_finish"},
		{src:"images/finish_blur.jpg?1656042482049", id:"_486_4_finish_blur"},
		{src:"images/tie_fp.png?1656042482049", id:"_486_4_tie_fp"},
		{src:"images/tie_sp.png?1656042482049", id:"_486_4_tie_sp"}
	],
	preloads: []
};
